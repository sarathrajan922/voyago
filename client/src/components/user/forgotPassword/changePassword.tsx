...
import { userUpdatePasswordWithEmail } from "../../../features/axios/api/user/userUpdatePasswordWithEmail";
...
const ChangePasswordComponent:React.FC = ()=>{
        ...
        return (
            ...
            <div className=" px-4 mx-auto max-w-screen-xl mt-14 lg:pt-0">
                  ...
                  >
                    {(formik) => (
                      <Form>
                        ...
                        <div className="flex items-center lg:pt-0 pt-8  justify-center w-full mb-10 ">
                          <div className="">
                            <button
                              type="submit"
