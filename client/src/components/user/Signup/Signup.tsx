...
const validationSchema: Yup.Schema<FormValues> = Yup.object({
  firstName: Yup.string().required('First name is required').matches(/^[A-Za-z]+$/, 'First name must contain only alphabetic characters').min(3, 'First name must be at least 3 characters').max(10, 'First name must less than 10 characters'),
  lastName: Yup.string().required('Last name is required').matches(/^[A-Za-z]+$/, 'Last name must contain only alphabetic characters').max(10, 'Last name must be less than 10 characters'),
