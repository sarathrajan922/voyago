...
//   >(null);
  ...
  const [joinedCommunity, setJoinedCommunity] = useState<GetAllCommunityApiResponse[] | null>(null)
  const [notJoinedCommunity, setNotJoinedCommunity] = useState<GetAllCommunityApiResponse[] | null>(null)
    ...
    const getAllCommunity = async () => {
      GetAllCommunity()
        ...
        //   setCommunities(response?.result.reverse());
          ...
          setNotJoinedCommunity(response?.result.notJoinedCommunities.reverse())
                ...
                joinedCommunity.map((doc, index) => {
                  return (
                    ...
                    >
                      ...
                      {
                        doc?.admin === userId ? <span className="inline-flex items-center justify-center w-6 h-6 mr-2 text-sm font-semibold text-green-500 bg-blue-100 rounded-full dark:bg-gray-700 dark:text-blue-400">
