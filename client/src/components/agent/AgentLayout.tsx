          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="flex-1 ml-3 whitespace-nowrap">Add Package</span>
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex items-center justify-center w-3 h-3 p-3 ml-3 text-sm font-medium text-green-500 bg-blue-100 rounded-full dark:bg-green-400 dark:text-black
                ">
                  3
                </span>
              </a>
