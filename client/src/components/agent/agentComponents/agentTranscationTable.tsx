...
const AgentRevenueTranscationTable: React.FC = () => {
  ...
  useEffect(() => {
    getAgentRevenue().then((res) => {
      setTranscationData(res.data.reverse());
    });
  }, []);
    ...
    <>
                ...
                return (
                  ...
                  >
                    ...
                    <td className="px-6 py-4 text-green-400">
                      {x.agentGet?.toLocaleString("en-IN", {
                        style: "currency",
                        currency: "INR",
                      })}{" "}
                      ++
      ...
      <div className="flex justify-center mt-10">
        ...
        <button
          ...
          disabled={
            currentPage ===
            Math.ceil(transcationData?.length ?? 0 / itemsPerPage)
          }
        >
          Next
          {/* Next button content */}
...
export default AgentRevenueTranscationTable;
